...
def loop():
	try:
		...
		print("Something went wrong.  Function is not running")
...
while count==0:
	loop()
	if ct==0:
		sendTGMessage("\nAzure is running!!","-1001339973178")
		ct=5
	else:
		ct=ct-1
